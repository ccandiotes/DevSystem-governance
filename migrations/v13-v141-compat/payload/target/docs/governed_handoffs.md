...
reports direct review links plus machine evidence. Immediately before tagging,
the Architect validates the manifest against the installed Draft 2020-12
schema and runs semantic, inventory, normalization, and digest checks. Either
validation layer failing blocks the tag. This does not authorize

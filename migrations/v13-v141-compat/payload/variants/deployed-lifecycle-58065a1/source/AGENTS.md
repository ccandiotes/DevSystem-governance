...
- `Prepare initial repository`: use only for a newly generated project whose
  ...
  `https://github.com/ccandiotes/elexon_ConfiguratorDBTransfer`; configure its remote as `origin` and default branch as
  `main`; and stage the complete generated baseline for review.

...
1. Keep this generated folder as the local workspace for **<Project Name>**. Do
...
2. Create the Implementer environment or conversation rooted at this folder and
   ...
   `<Project Name> - Implementer - <Development Focus>`. If the interface names
...
3. Ensure the Implementer can authenticate to GitHub. Issue this exact
   ...
   **<Repository Name>** at **<Repository URL>** on default branch
   **<Default Branch>**, but cannot commit or publish it.
...
7. Create the Architect conversation and copy and send the complete project-specific
   ...
   `<Project Name> - Architect - <Development Focus>`, renaming it after its first turn
...
8. Verify both roles report repository **<Repository Name>**, URL
   **<Repository URL>**, branch **<Default Branch>**, and the installed
   governance baseline.
